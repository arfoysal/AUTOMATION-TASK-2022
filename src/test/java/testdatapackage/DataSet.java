...
public class DataSet {
	...
	public static Object dataset() {
		...
		Object[][] obj = {
				...
				{ "johnKanir1011@gmalla.com", "John", "Kanir", "testpass123@", "12", "7", "2000", "AdventureSports",
				...
				{ "jacyjane1012@dffda.com", "Jacy", "Jane", "@testpass123", "28", "5", "1990", "Market Basket",
	...
	public static Object emailset() {
		...
		// email
		Object[][] obj = { { "johnKanir1011@gmalla.com", "testpass123@", "Call before knock the door" },
				{ "jacyjane1012@dffda.com", "@testpass123", "Be aware about dog" } };
		return obj;
